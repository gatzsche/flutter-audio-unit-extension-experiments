...
@interface FlutterExampleAUV3AudioUnit ()
...
@implementation FlutterExampleAUV3AudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[FlutterExampleAUV3DSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block FlutterExampleAUV3DSPKernelAdapter * kernelAdapter = _kernelAdapter;
