//
//  FlutterExampleAUV3DSPKernel.hpp
//  FlutterExampleAUV3
//
//  Created by Gabriel Gatzsche on 28.12.21.
//

#ifndef FlutterExampleAUV3DSPKernel_hpp
#define FlutterExampleAUV3DSPKernel_hpp
...
/*
 FlutterExampleAUV3DSPKernel
 Performs simple copying of the input signal to the output.
 As a non-ObjC class, this is safe to use from render thread.
 */
class FlutterExampleAUV3DSPKernel : public DSPKernel {
public:
...
#endif /* FlutterExampleAUV3DSPKernel_hpp */
